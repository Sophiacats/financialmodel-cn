...
st.markdown("💹 智能投资分析系统 v2.0 | 仅供参考，投资需谨慎")def generate_trading_recommendation(valuation_signals, technical_signals, current_price, dcf_value):
    """生成交易建议"""
    recommendation = {
        'action': 'HOLD',
        'confidence': 0,
    ...
    if buy_signals >= 2:
        ...
        recommendation['reasons'].insert(0, "建议减仓或清仓")
        recommendation['entry_range'] = (current_price * 0.98, current_price * 1.02)
        recommendation['stop_loss'] = current_priceimport streamlit as st
